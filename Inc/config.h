...
// ############################ VARIANT_HOVERCAR SETTINGS ############################
  ...
  #define FLASH_WRITE_KEY         0x1108  // Flash memory writing key. Change this key to ignore the input calibrations from the flash memory and use the ones in config.h
  #undef  CTRL_MOD_REQ
  ...
  #define PRI_INPUT2              3, 900, 2150, 3400, 150  // Pedal Accel     TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
